###########################################################################################
#														                                                                        
# 				     	Script RMSCheck_EpFull v1.5
#
###########################################################################################
#
## USAGE
# pymol -c RMSCheck_EpFull.py
# 
#
## DETAILS
...
cmd.alter (("all"),'segi=""')
# Run rms after fit by epitope
cmd.do ("rms EP1, EP2")
# Run rms after fit by MHC
cmd.do ("rms_cur EP1, EP2")
## Run rms_current.py
cmd.do ("run /usr/local/bioscripts/rms_current.py")
## RMSD Calculation between EP1 and EP2 (backbone atoms) with rms_current.py
cmd.do ("rms_current EP1, n. n+ca+c+o, EP2, n. n+ca+c+o")
## RMSD Calculation between EP1 and EP2 (CA) with rms_current.py
