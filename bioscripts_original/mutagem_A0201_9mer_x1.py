...
# - Arquivo com o epitopo padrao (HLA-A0201_9mer_pattern.pdb) na pasta ~/Documentos/MATERIAL_REFERENCIA/ARQUIVOS/Dock_Files_2012-07-01/ 
...
cmd.do ("reinitialize")
#
## Abrir o epitopo 9mer padrao de HLA-A0201 e o epitopo desejado para modelagem
cmd.load ("/usr/local/bioscripts/biofiles/HLA-A0201_9mer_pattern.pdb")
