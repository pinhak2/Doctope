...
# - Arquivo com o epitopo padrao (H2Db_10mer_pattern) na pasta ~/Documentos/MATERIAL_REFERENCIA/ARQUIVOS/Dock_Files_2012-07-01/ 
...
cmd.do ("reinitialize")
#
## Abrir o epitopo 9mer padrao de H2Db_10mer e o epitopo desejado para modelagem
cmd.load ("/usr/local/bioscripts/biofiles/H2Db_10mer_pattern.pdb")
...
cmd.iterate ('("H2Db_10mer_pattern")' and 'name CA', 'chainresnresiMHC.append([("H2Db_10mer_pattern"),chain,resn,resi])')
...
for i in range(len(chainresnresiEPITOPO)):
    ...
    selection="/H2Db_10mer_pattern//C/%s"%(chainresnresiMHC[i][3])
    # Fazer a troca
