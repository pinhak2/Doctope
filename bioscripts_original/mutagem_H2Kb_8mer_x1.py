...
# - Arquivo com o epitopo padrao (H2Kb_8mer_pattern) na pasta ~/Documentos/MATERIAL_REFERENCIA/ARQUIVOS/Dock_Files_2012-07-01/ 
...
cmd.do ("reinitialize")
#
## Abrir o epitopo 9mer padrao de H2Kb_8mer e o epitopo desejado para modelagem
cmd.load ("/usr/local/bioscripts/biofiles/H2Kb_8mer_pattern.pdb")
...
cmd.iterate ('("H2Kb_8mer_pattern")' and 'name CA', 'chainresnresiMHC.append([("H2Kb_8mer_pattern"),chain,resn,resi])')
...
for i in range(len(chainresnresiEPITOPO)):
    ...
    selection="/H2Kb_8mer_pattern//D/%s"%(chainresnresiMHC[i][3])
    # Fazer a troca
